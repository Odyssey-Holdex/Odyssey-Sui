#[test_only]
module trading_vault::maker_vault_tests;

use sui::test_scenario::{Self, ctx};
use sui::coin::{Self};
use trading_vault::maker_vault::{Self, MakerVault, MakerVaultAdminCap, MakerOrderCap};
use trading_vault::types::{Self};
use trading_vault::test_utils::{Self, USDC, ITHACA, setup_test_scenario, mint_usdc, mint_ithaca, get_test_addresses, cleanup_scenario};
